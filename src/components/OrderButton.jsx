...
const OrderButton = ({ productName, price, phone='+2347034781890', email='jesulobadaniel1@gmail.com' }) => {
  ...
  return (
    <div className="flex gap-4">
      <a
        ...
        className="bg-primary text-bg px-6 py-3 rounded-md flex items-center gap-2 hover:bg-accent transition"
      >
      ...
      <a
        ...
        className="bg-accent text-bg px-6 py-3 rounded-md flex items-center gap-2 hover:bg-primary transition"
      >
